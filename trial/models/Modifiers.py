class Modifiers:
    def __init__(self, m_str, m_dex, m_con, m_int, m_wis, m_cha):
        self.__m_str__ = self.__calculate_modifier__(m_str)
        self.__m_dex__ = self.__calculate_modifier__(m_dex)
        self.__m_con__ = self.__calculate_modifier__(m_con)
        self.__m_int__ = self.__calculate_modifier__(m_int)
        self.__m_wis__ = self.__calculate_modifier__(m_wis)
        self.__m_cha__ = self.__calculate_modifier__(m_cha)

    def __calculate_modifier__(self, modifier):
        if modifier <= 0:
            return 0
